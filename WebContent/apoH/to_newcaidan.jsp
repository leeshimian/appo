		...
		<div id="bodyy">
			...
			<div id="right">
				...
				<div id="c2">
                    ...
                    String ucai_img=request.getParameter("cai_img");
                    String img="img/1256607214.jpg";
                    int num=0;
                    int vipnum=0;
                    
                    connDB.getConn();
                    String sql="insert into greens values(apo_cai_id.nextval,?,?,?,?,?,?,?,?,?)";
                    int i=connDB.updateEmp(sql,cai_name,cai_mPrice,cai_vipPrice,cai_material,cai_kind,img,cai_info,num,vipnum);
                    if(i>0){System.out.println("添加成功");%>
                            <br /><br />
                            <p style="margin-top:10px;text-align:center">您添加成功</p>
                    ...
                    <%
                            ...
                            <br /><br />
                            <p style="margin-top:10px;text-align:center">您添加失败</p>
                          
                    			<p style="margin-top:20px;text-align: center;"><form action="newcaidan.jsp" style="display: inline-block;margin-top: 30px;margin-left:560px;"><input type="submit" value="重新添加"></form></p>
                    	<br /><br />   <% }
